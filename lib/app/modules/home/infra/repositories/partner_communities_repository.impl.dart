...
class PartnerCommunitiesRepositoryImpl implements PartnerCommunitiesRepository {
  ...
  @override
  Future<Either<FailureGetPartnerCommunities, List<ResultPartnerCommunities>>> get() async {
    try {
  ...
  @override
  Future<Either<FailureGetPartnerCommunities, ResultFollowers>> getFolowers() async {
    try {
