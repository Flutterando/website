...
@Injectable()
class LatestChannelVideosController = _LatestChannelVideosControllerBase with _$LatestChannelVideosController;

abstract class _LatestChannelVideosControllerBase with Store {
  final GetYoutube getYoutube;
  final ScreenSize screen;
  _LatestChannelVideosControllerBase(this.getYoutube, this.screen) {
    fetchYoutube();
  }
  ...
  fetchYoutube() async {
    ...
    response.fold((l) => error = l.toString(), (r) => youtube = r.asObservable());
  }
}
